...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    SFT_BSL,  KC_Z,     KC_X,     KC_C,   KC_V,   KC_B,   KC_PAUS, KC_N,     KC_M, KC_COMM, KC_DOT,  KC_SLSH, SFT_MIN,
    KC_LCTL,  KC_LEAD,                    GUITAB, LW_BSP,          FN_SPC,   GUIGO,                            KC_RALT, M6
    ),

    [_FN] = LAYOUT(
    KC_CAPS, KC_BTN4, _______, _______, _______, M1_PLY,           _______, _______, KC_HOME, KC_END,  _______, KC_DEL,  _______,
    _______, _______, _______, _______, _______, M2_PLY,           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, _______, _______, _______, _______, _______, M1,      M2,      _______, KC_PGUP, KC_PGDN,      M5, _______,
    _______, _______,                   _______, _______,          _______, _______,                   _______, _______
    ),

    [_LW] = LAYOUT(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR, KC_PERC,           KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PLUS, _______,
    ...
    [_RS] = LAYOUT(
    _______, _______, _______, _______, M_STOP,  M1_REC,           KC_INS,  _______, _______, _______, _______, KC_SLCK, KC_PAUS,
    _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, M1_REC,           _______, _______, _______, _______, _______, _______,
