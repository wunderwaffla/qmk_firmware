...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    SFT_BSL,  KC_Z,     KC_X,     KC_C,   KC_V,   KC_B,          KC_PAUSE, KC_N,     KC_M, KC_COMM, KC_DOT,  KC_SLSH, SFT_MIN,
    KC_LCTL,  KC_LEAD,                    GUITAB, LW_BSP,        FN_SPC,   GUIGO,                            KC_RALT, M6
    ),

    [_FN] = LAYOUT(
    KC_CAPS, KC_BTN4, _______, _______, _______, M1_PLY,         _______, _______, KC_HOME, KC_END,  KC_O,    KC_P,    KC_LBRC,
    _______, _______, _______, _______, _______, M2_PLY,         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, _______, _______, _______, _______, _______,        M1,      M2,      KC_PGUP, KC_PGDN, M5,      _______, _______,
