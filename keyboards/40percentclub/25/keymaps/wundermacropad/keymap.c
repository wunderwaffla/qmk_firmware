...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_QW] = {
  ...
  { ______,  ______,  M2,     KC_BTN2, PLAY   },
 },

 [_FN] = {
  { ______,  ______, ______,    ______, M_STOP, },
  { C(KC_1), C(KC_2), C(KC_3), M1_S,   M2_S,   },
  { C(KC_4), C(KC_5), C(KC_6), ______, ______, },
  { C(KC_7), C(KC_8), C(KC_9), ______, ______, },
