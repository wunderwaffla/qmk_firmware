 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_GRV,  KC_MINS, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, CTL_T(KC_ENT),  KC_EQL},
  { SFT_GRV, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_MIN,        KC_DEL},
 ...
 [_FN] = { /* FUNCTION */
  ...
  { ______,  KC_GRV,  KC_VOLU, KC_MPLY, KC_MNXT, ______,  ______,  ______,  KC_PGUP, KC_HOME, KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,         ______ },
  { ______,  ______,  KC_VOLD, KC_MSTP, KC_MPRV, ______,  ______,  ______,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MINS, ______,         ______ },
 ...
 [_LW] = { /* LOWER */
  ...
  { ______,  KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, ______,  RGB_TOG, RGB_MOD, ______,  KC_P4,   KC_P5,   KC_P6,   KC_PPLS, CTL_T(KC_PENT), ______ },
