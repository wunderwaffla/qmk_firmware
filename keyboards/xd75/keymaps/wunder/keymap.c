 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_TAB,  KC_Q,    KC_W,   KC_E,    KC_R,   KC_T,    KC_BSLS, KC_RBRC, KC_LBRC, KC_Y,   KC_U,   KC_I,    KC_O,   KC_P,    KC_QUOT},
  ...
  { TT(_LW), KC_LGUI, FN_SPC, KC_LALT, FN_SPC, FN_SPC,  KC_LEFT, KC_F14, KC_RGHT, FN_SPC, FN_SPC, KC_RALT, FN_SPC, KC_RGUI, TT(_LW)},
 },
