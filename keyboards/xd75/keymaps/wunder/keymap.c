 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_PAUS, KC_F23,  KC_F15,  KC_LGUI, FN_BSP,  TT(_LW), KC_LALT, KC_RALT, TT(_LW), FN_SPC, KC_RGUI, KC_F16, KC_F17,  KC_F18,  KC_F19},
 },

 [_FN] = { /* FUNCTION */
  { KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   ______,  ______,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   ______ },
  { ______,  ______,  KC_VOLU, KC_MPLY, KC_MNXT, ______,  ______,  ______,  KC_PGUP, KC_HOME, KC_LBRC, KC_RBRC, ______,  KC_DEL,   ______ },
 ...
 [_LW] = { /* LOWER */
  ...
  { ______,  ______,  KC_WH_L, KC_WH_R, KC_BTN3, KC_BTN2, RGB_HUI, RGB_VAI, KC_BTN1, KC_P1,   KC_P2,   KC_P3,   KC_PDOT, ______,   RGB_SAI },
  { ______,  ______,  ______,  ______,  ______,  ______,  RGB_HUD, RGB_VAD, ______,  ______,  ______,  ______,  ______,  ______,   RGB_SAD },
 },
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (record->event.pressed) {
    switch(keycode) {
      case M1:
        SEND_STRING("gotogit"SS_TAP(X_ENTER)); // this is our macro!
        return false; break;
      case M2:
