...
// define LAYOUT_60_ansi_split_bs_rshift(
  ...
  [_QW] = LAYOUT_60_ansi_split_bs_rshift(
    ...
    KC_LCTL, KC_LGUI,          KC_LALT,                   FN_SPC,                             KC_RALT, KC_RGUI,          MO(_FN), KC_RCTL
    ),

  [_FN] = LAYOUT_60_ansi_split_bs_rshift(
    _______, KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, _______,
    _______,         _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______, _______, _______, _______, _______, KC_DEL,
